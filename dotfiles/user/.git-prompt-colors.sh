# material-monokai colors
# \e[0;38;5;241m - coolgrey
# \e[0;38;5;149m - green
# \e[0;38;5;197m - red
# \e[0;38;5;27m - blue
# \e[0;38;5;220m - orange
...
override_git_prompt_colors() {
  ...
  GIT_PROMPT_PREFIX="\e[01;38;5;241m⎇ "                 # start of the git info string
  # GIT_PROMPT_PREFIX="\e[01;38;5;241m["                 # start of the git info string
  GIT_PROMPT_SUFFIX="\e[0;38;5;241m"                 # the end of the git info string
  # GIT_PROMPT_SUFFIX="\e[0;38;5;241m]"                 # the end of the git info string
  GIT_PROMPT_SEPARATOR="\e[0;38;5;241m |"              # separates each item

  GIT_PROMPT_BRANCH="\e[0;38;5;141m"        # the git branch that is active in the current directory
  ...
  GIT_PROMPT_STAGED="\e[0;38;5;149m ● "           # the number of staged files/directories
  GIT_PROMPT_CONFLICTS="\e[0;38;5;197m ✖ "      # the number of files in conflict
  GIT_PROMPT_CHANGED="\e[0;38;5;197m ✚ "        # the number of changed files

  # GIT_PROMPT_REMOTE=" "                      # the remote branch name (if any) and the symbols for ahead and behind
  GIT_PROMPT_UNTRACKED="\e[0;38;5;220m …"       # the number of untracked files/dirs
  GIT_PROMPT_STASHED="\e[01;38;5;63m ⚑ "           # the number of stashed files/dir
  GIT_PROMPT_CLEAN="\e[01;38;5;149m ✔"           # a colored flag indicating a "clean" repo

  ## For the command indicator, the placeholder _LAST_COMMAND_STATE_ 
  ## will be replaced with the exit code of the last command
  ## e.g.
  # GIT_PROMPT_COMMAND_OK="${Green}✔-_LAST_COMMAND_STATE_ "    # indicator if the last command returned with an exit code of 0
  # GIT_PROMPT_COMMAND_FAIL="\e[0;38;5;197m✘-_LAST_COMMAND_STATE_ "    # indicator if the last command returned with an exit code of other than 0
