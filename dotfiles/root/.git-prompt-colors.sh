...
override_git_prompt_colors() {
  ...
  GIT_PROMPT_STAGED="\e[0;38;5;142m ● "           # the number of staged files/directories
  GIT_PROMPT_CONFLICTS="\e[0;38;5;208m ✖ "      # the number of files in conflict
  GIT_PROMPT_CHANGED="\e[0;38;5;208m ✚ "        # the number of changed files

  # GIT_PROMPT_REMOTE=" "                      # the remote branch name (if any) and the symbols for ahead and behind
  GIT_PROMPT_UNTRACKED="\e[0;38;5;167m …"       # the number of untracked files/dirs
  GIT_PROMPT_STASHED="\e[01;38;5;39m ⚑ "           # the number of stashed files/dir
